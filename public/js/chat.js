const socket = io() // socket here is used to send and receive events
...
$sendLocationButton.addEventListener('click', () => {
    ...
    navigator.geolocation.getCurrentPosition((position) => { // position object contains information we need to share
        let location = {
